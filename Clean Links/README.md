...
3. Open your computer's Terminal and navigate to the Clean Links directory. That will usually involve entering the following (make sure to swap out "your_username" for the correct text):
